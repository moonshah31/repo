...
document.addEventListener("DOMContentLoaded", function () {
   ...
   if (loadingSpinner) {
      loadingSpinner.style.display = 'block'; // Show the loading spinner immediately
   }

   window.onload = function () {
      if (loadingSpinner) {
         loadingSpinner.style.display = 'none'; // Hide the loading spinner when all assets are loaded
      }
   };
});
document.addEventListener("DOMContentLoaded", function () {
